...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Garage.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Demande.class.getName(), jcacheConfiguration);
